                      ...
                      <div key={c.id} className="group relative">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="relative w-32">
                            ...
                            />
                            <span className="absolute right-3 top-1/2 -translate-y-1/2 text-[10px] text-slate-400 leading-none pointer-events-none" aria-hidden="true">€</span>
                          </div>
                    ...
                    {activeSim.data.loyers.map((l, i) => (
                      <div key={i} className="flex items-center gap-4 group">
                        ...
                        <div className="relative flex-1">
                          ...
                          />
                          <span className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 text-xs font-medium pointer-events-none" aria-hidden="true">€</span>
                        </div>
                      </div>
                    ))}
