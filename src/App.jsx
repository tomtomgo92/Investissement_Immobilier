                    ...
                    {activeSim.data.charges.map((c) => (
                      <div key={c.id} className="group relative">
                        <div className="flex items-center gap-3">
                          ...
                          <button aria-label={`Supprimer la charge ${c.name}`} onClick={() => removeCharge(c.id)} className="opacity-0 group-hover:opacity-100 focus-visible:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-1 dark:focus-visible:ring-offset-slate-800 rounded-md text-danger hover:text-red-600 transition-opacity">
                            <Trash2 size={14} />
                          </button>
                        </div>
                      </div>
