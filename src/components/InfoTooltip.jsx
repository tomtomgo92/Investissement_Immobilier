  ...
  return (
    <div className="group relative flex items-center">
      <button
        type="button"
        aria-describedby={id}
        className="cursor-help focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-1 dark:focus-visible:ring-offset-slate-800 rounded-full"
      >
