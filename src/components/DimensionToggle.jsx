...
export default function DimensionToggle({ active, onClick, dot, label }) {
    return (
        <button
            onClick={onClick}
            aria-pressed={active}
            className={`flex items-center gap-2 px-3 py-1.5 rounded-full border transition-all text-[10px] font-bold uppercase tracking-tight focus-visible:ring-2 focus-visible:ring-offset-1 focus-visible:ring-indigo-500 ${active
