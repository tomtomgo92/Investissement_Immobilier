...
## 2024-05-25 - Interactive Elements Hidden with Opacity
**Learning:** Hiding interactive elements (like action buttons) using `opacity-0` makes them undiscoverable and inaccessible to keyboard users tabbing through the UI.
**Action:** Always add `focus-visible:opacity-100` alongside explicit `focus-visible` styling (`focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 rounded`) to ensure they appear when focused.
